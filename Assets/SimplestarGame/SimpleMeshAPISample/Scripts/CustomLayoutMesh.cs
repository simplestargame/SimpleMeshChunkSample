...
namespace SimplestarGame
{
    ...
    /// <summary>
    /// カスタムレイアウトメッシュを作成するクラス
    /// </summary>
    internal class CustomLayoutMesh
    {
        public static VertexAttributeDescriptor[] VERTEX_ATTRIBUTE_DESCRIPTORS = new VertexAttributeDescriptor[] {
        ...
        CopyMeshJob MakeCopyJob(Mesh.MeshDataArray meshDataArray, int meshIdx, int subMeshCount, int vertexCount, int indexCount, MeshSource meshSource)
        {
            ...
            meshData.SetVertexBufferParams(vertexCount, VERTEX_ATTRIBUTE_DESCRIPTORS);
